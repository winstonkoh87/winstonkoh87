...
| **Automation** | **280 scripts** | Python automation stack (boot, shutdown, search, sync, hooks, governance) |
| **Memory Corpus** | **4,870 files** | Grounded episodic and semantic knowledge corpus |
